...
static void *migration_thread(void *opaque)
{
	...
	//printf("check8\n");
	    ...
	    //if(iterations < 20){
	    /*Dinuni: pending size <= 5000 or 20 iteration, which ever comes first , 
	     * it breaks and goes to migration complettion
             */
            if((((uint64_t)(pending_size/4096LLU)) >= 5000LLU ) && (iterations <= 20)){
